...
//     <section
//       ref={sectionRef}
//       className="relative min-h-screen overflow-hidden bg-[#f6f1e8] px-5 pb-24 pt-40 md:pt-48"
//     >
//       <style>{`
//         @keyframes floatSoft {
...
//       {/* floating chips */}
//       <div className="float-soft absolute left-[4%] top-[26%] hidden rounded-2xl border border-black/10 bg-white/80 px-4 py-3 text-sm font-medium text-black/65 shadow-xl shadow-black/5 backdrop-blur md:block">
...
//       <div className="float-soft-delay absolute right-[2%] top-[32%] hidden rounded-2xl border border-black/10 bg-white/80 px-4 py-3 text-sm font-medium text-black/65 shadow-xl shadow-black/5 backdrop-blur md:block">
//         <div className="flex items-center gap-2">
...
//       <div className="float-soft-delay2 absolute bottom-[45%] left-[5%] hidden rounded-2xl border border-black/10 bg-white/80 px-4 py-3 text-sm font-medium text-black/65 shadow-xl shadow-black/5 backdrop-blur md:block">
//         <div className="flex items-center gap-2">
...
//         <div className="fade-up mx-auto mb-8 inline-flex items-center gap-2 rounded-full border border-black/10 bg-white/70 px-5 py-2 text-xs font-semibold uppercase tracking-wide text-black/70 shadow-sm backdrop-blur">
//           <Sparkles size={14} className="text-blue-500" />
//           For B2B technology companies
//         </div>

//         <h1 className="fade-up-1 mx-auto max-w-6xl text-5xl font-semibold leading-[0.95] tracking-[-0.07em] text-black md:text-7xl lg:text-8xl">
//           Go-to-market systems for{" "}
//           <span className="block font-serif italic font-normal tracking-[-0.05em]">
//             predictable{" "}
//             <span
//               key={wordIndex}
//               className="word-animate inline-block text-blue-600"
//             >
//               {words[wordIndex]}
//             </span>
//           </span>
...
//         <p className="fade-up-2 mx-auto mt-8 max-w-3xl text-lg leading-8 text-black/60 md:text-xl">
...
//         {/* form CTA
//         <div className="fade-up-3 mx-auto mt-10 flex max-w-2xl flex-col overflow-hidden rounded-2xl border border-black/10 bg-white/80 p-2 shadow-2xl shadow-black/10 backdrop-blur md:flex-row">
//           <input
//             type="email"
//             placeholder="Work email"
//             className="min-h-14 flex-1 bg-transparent px-5 text-sm text-black outline-none placeholder:text-black/40"
//           />
...
//             className="min-h-14 flex-1 bg-transparent px-5 text-sm text-black outline-none placeholder:text-black/40"
//           />
//           <button className="pulse-glow group min-h-14 rounded-xl bg-blue-500 px-7 text-sm font-semibold text-white transition hover:bg-blue-600">
...
//         {/* form CTA */}
//         <div className="fade-up-3 mx-auto mt-10 flex max-w-4xl flex-col gap-3 rounded-2xl border border-black/10 bg-white/80 p-3 shadow-2xl shadow-black/10 backdrop-blur md:flex-row md:items-center">
//           {/* Email Input */}
//           <div className="flex items-center w-full bg-[#f1f2f6] rounded-full px-3 py-2">
...
//               type="email"
//               placeholder="Work email"
//               className="bg-transparent w-full text-sm text-black placeholder:text-black/40 border-none outline-none focus:outline-none focus:ring-0"
//             />
//           </div>
...
//           {/* Button */}
//           <button className="pulse-glow group min-h-14 rounded-full bg-gradient-to-r from-purple-500 to-indigo-500 px-5 text-sm font-semibold text-white transition hover:scale-105 whitespace-nowrap">
//             <span className="inline-flex items-center gap-2">
//               Request call
//               <ArrowRight
//                 size={15}
...
//         {/* tags */}
//         <div className="fade-up-4 mt-8 flex flex-wrap items-center justify-center gap-3">
...
//         {/* Stats row */}
//         <div className="fade-up-4 mt-16 grid grid-cols-2 gap-4 md:grid-cols-4">
//           {[
...
//     <section
//       ref={sectionRef}
//       className="relative min-h-screen overflow-hidden bg-[#f6f1e8] px-4 sm:px-5 pb-20 sm:pb-24 pt-32 sm:pt-40 md:pt-48"
//     >
//       <style>{`
//         @keyframes floatSoft {
//           0%, 100% { transform: translateY(0px) rotate(0deg); }
...
//       {/* floating chips untouched */}
//       <div className="float-soft absolute left-[4%] top-[26%] hidden md:block rounded-2xl border border-black/10 bg-white/80 px-4 py-3 text-sm font-medium text-black/65 shadow-xl backdrop-blur">
//         <div className="flex items-center gap-2">
//           <Zap size={13} className="text-blue-500" />
//           Signal-based outbound
//         </div>
...
//       <div className="float-soft-delay absolute right-[2%] top-[32%] hidden md:block rounded-2xl border border-black/10 bg-white/80 px-4 py-3 text-sm font-medium text-black/65 shadow-xl backdrop-blur">
//         <div className="flex items-center gap-2">
//           <TrendingUp size={13} className="text-blue-500" />
//           AI RevOps automation
//         </div>
...
//       <div className="float-soft-delay2 absolute bottom-[45%] left-[5%] hidden md:block rounded-2xl border border-black/10 bg-white/80 px-4 py-3 text-sm font-medium text-black/65 shadow-xl backdrop-blur">
//         <div className="flex items-center gap-2">
//           <Users size={13} className="text-blue-500" />
//           CRM-ready pipeline
//         </div>
...
//             </div>
//             <input
//               className="bg-transparent w-full text-sm outline-none placeholder:text-black/40"
//               placeholder="Work email"
//             />
//           </div>
